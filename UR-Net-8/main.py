...
parser.add_argument('--checkpoint_dir', dest='checkpoint_dir', default='../tubulin-models/example-data-tubulin-model-WF+MU-SRM-to-SRM/model/UR-Net-8/', help='models are saved here')
