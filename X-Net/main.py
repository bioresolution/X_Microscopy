...
# X-Microscopy/tubulin-models/tubulin-models/example-data-tubulin-model-WF+MU-SRM-to-SRM
# /home/admin1/Gauri_Project/X_Microscopy/X-Microscopy/tubulin-models